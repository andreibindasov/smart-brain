        ...
        return  <div className="profile-modal">
            <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
                <main className="pa4 black-80 w-80">
                    <img src="https://tachyons.io/img/logo.jpg" className="h3 w3 dib" alt="ava"/>
                    <h1>{this.state.name}</h1>
                    <h4>{`Faces recognized: ${user.entries}`}</h4>
                    ...
                    <input
                        ...
                        id="age"
                    />
                    <label className="mt2 fw6" htmlFor="user-phone">Phone:</label>
                    <input
                        onChange = {this.onFormChange}
                        className="pa2 ba w-100"
                    ...
                    <div className="mt4" style={{display: 'flex', justifyContent: 'space-evenly'}}>
                        <button 
                            onClick={() => this.onProfileUpdate({ name, age, phone })}
